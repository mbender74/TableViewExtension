...
<modules>
  <module version="1.0.0">de.marcbender.tableviewextension</module>
</modules>
...
```js
import MyModule from 'de.marcbender.tableviewextension';
MyModule.foo();
```
...
```js
var MyModule = require('de.marcbender.tableviewextension');
MyModule.foo();
```
